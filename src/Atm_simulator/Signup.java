    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if(t6.getText().equals("")){
                ...
                Conn c1 = new Conn();
                if (c1 != null) {
                    String q1 = "insert into signup values('" + formno + "','" + name + "','" + fname + "','" + dob + "','" + gender + "','" + email + "','" + marital + "','" + address + "','" + city + "','" + Postalcode + "','" + Branch + "')";
                    c1.s.executeUpdate(q1);
                } else {
                    System.out.println("Connection failed. c1 is null.");
                }
