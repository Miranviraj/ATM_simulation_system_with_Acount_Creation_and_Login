...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
        ...
        String religion[] = {"Sinhala","Hindu","Muslim","Christian","Other"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t1.getText().equals("")){
                ...
                Conn c1 = new Conn();
                String q1 = "insert into signuptwo values('"+formno+"','"+religion+"','"+income+"','"+education+"','"+occupation+"','"+pan+"','"+scitizen+"','"+eaccount+"')";
